      ...
      <div className="page-shell section-pad">
        <div className="about-grid">
          <div className="min-w-0">
            ...
            <div className="prose-clean mt-5 text-[15px] sm:text-base">
              <p>
                ...
                <strong>играть онлайн на деньги</strong>, открыть демо и быстро
                сверить параметры без огромного каталога.
              </p>
              <p>
          ...
          <aside className="about-aside">
            <div className="about-cover">
              <Image
                ...
                alt="Обложка Mine Drop 2 — Paperclip Gaming"
                fill
