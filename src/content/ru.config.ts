...
export const ruConfig = {
  ...
  ui: {
    ...
    footer: {
      ...
      cta: "Выбрать площадку",
      legal:
        "18+. Играйте ответственно. Азартные игры могут вызывать зависимость. Сайт не является официальной страницей разработчика. На сайте используются партнёрские ссылки.",
    },
