...
export async function generateMetadata({ params }: Props) {
  ...
  return buildSeoPageMetadata(config, getSeoPage("ru", slug));
}

export default async function RussianSeoPage({ params }: Props) {
  const { slug } = await params;
  ...
  return <SeoHubPage config={config} page={getSeoPage("ru", slug)} />;
}
